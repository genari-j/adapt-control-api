...
async function execSeeds() {
  ...
  const categories = [
    ...
    { name: 'Carnes e Peixes', description: 'Produtos como carne de res, suíno, aves e peixes são comumente encontrados nesta categoria' },
    { name: 'Produtos Lácteos', description: 'Inclui leite, iogurte, queijo, manteiga e outros produtos derivados da lactose' },
    { name: 'Alimentícios Prontos', description: 'Produtos como salgadinhos, congelados, doces e outros alimentos que não requerem preparação antes do consumo' },
    { name: 'Produtos de Panificação', description: 'Inclui pães, bolos, massas e outros produtos de panificação' },
    { name: 'Produtos de Limpeza', description: 'Produtos de limpeza doméstica, cuidados pessoais e produtos de higiene' },
